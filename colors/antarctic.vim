...
hi Comment ctermbg=253 ctermfg=232 cterm=italic guibg=#dadada guifg=#080808 gui=italic
hi Constant ctermbg=NONE ctermfg=20 cterm=NONE guibg=NONE guifg=#0000d7 gui=NONE
...
hi String ctermbg=NONE ctermfg=20 cterm=NONE guibg=NONE guifg=#0000d7 gui=NONE
hi Todo ctermbg=224 ctermfg=234 cterm=bold guibg=#ffd7d7 guifg=#1c1c1c gui=bold
hi Type ctermbg=254 ctermfg=234 cterm=NONE guibg=#e4e4e4 guifg=#1c1c1c gui=NONE
hi Underlined ctermbg=254 ctermfg=234 cterm=underline guibg=#e4e4e4 guifg=#1c1c1c gui=underline
...
hi helpLeadBlank ctermbg=254 ctermfg=234 cterm=NONE guibg=#e4e4e4 guifg=#1c1c1c gui=NONE
hi helpNormal ctermbg=254 ctermfg=234 cterm=NONE guibg=#e4e4e4 guifg=#1c1c1c gui=NONE
...
hi FoldColumn ctermbg=249 ctermfg=16 cterm=NONE guibg=#b2b2b2 guifg=#000000 gui=NONE
hi Folded ctermbg=249 ctermfg=16 cterm=italic guibg=#b2b2b2 guifg=#000000 gui=italic
hi WildMenu ctermbg=230 ctermfg=234 cterm=NONE guibg=#ffffd7 guifg=#1c1c1c gui=NONE
hi SpecialKey ctermbg=254 ctermfg=234 cterm=NONE guibg=#e4e4e4 guifg=#1c1c1c gui=NONE
...
hi DiffText ctermbg=226 ctermfg=234 cterm=NONE guibg=#ffff00 guifg=#1c1c1c gui=NONE
hi Search ctermbg=226 ctermfg=NONE cterm=NONE guibg=#ffff00 guifg=NONE gui=NONE
hi Directory ctermbg=254 ctermfg=234 cterm=NONE guibg=#e4e4e4 guifg=#1c1c1c gui=NONE
...
hi SpellRare ctermbg=194 ctermfg=234 cterm=NONE guibg=#d7ffd7 guifg=#1c1c1c gui=NONE
